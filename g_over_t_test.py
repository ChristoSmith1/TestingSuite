...
powerdata = g_over_t.read_power_file(r"TestingSuite\MSU_PowerMeter_GoverT_09202023_2300UTC_3.csv")
#print(powerdata)

pointingdata = g_over_t.read_px6_file(r"TestingSuite\merge_test\GTprocedure_3.txt")
#print(pointingdata)
